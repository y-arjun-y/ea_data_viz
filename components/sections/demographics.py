...
def demographics_section():
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.Div(get_bar_chart("gender"), className="plot-container"),
                    html.Div(get_bar_chart("age_group"), className="plot-container"),
                    html.Div(
    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.Div(
                        get_bar_chart("political_belief"), className="plot-container"
                    ),
                    html.Div(get_bar_chart("diet"), className="plot-container"),
                    html.Div(
...
def education_section():
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.Div(get_bar_chart("education2"), className="plot-container"),
                    html.Div(get_bar_chart("subject"), className="plot-container"),
                ],
...
def career_section():
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.Div(get_bar_chart("career_path"), className="plot-container"),
                    html.Div(get_bar_chart("employment"), className="plot-container"),
                ],
                className="grid tab-cols-2 desk-cols-2 section-body",
            ),
            get_data_source("rethink19"),
