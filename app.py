...
app.clientside_callback(
    ...
    function (value) {
            ...
            if (value["row"] == 0) {
                document.getElementById("x-risks-img").src = "/assets/x-risks-imgs/landmark-solid.svg";
                ...
                document.getElementById("x-risks-img").src = "/assets/x-risks-imgs/clover-solid.svg";
            ...
            document.getElementById("x-risks-img").src = "/assets/x-risks-imgs/dice-solid.svg";
                ...
                document.getElementById("x-risks-img").src = "/assets/x-risks-imgs/phone-solid.svg";
                ...
                document.getElementById("x-risks-img").src = "/assets/x-risks-imgs/mask-face-solid.svg";
